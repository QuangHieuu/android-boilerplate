...
fun <T : Activity> Fragment.goTo(
    ...
    if (bundle != null) intent.putExtra(gg.it.constant.Constants.EXTRA_ARGS, bundle)
    if (parcel != null) intent.putExtra(gg.it.constant.Constants.EXTRA_ARGS, parcel)
